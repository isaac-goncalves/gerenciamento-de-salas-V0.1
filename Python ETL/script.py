...
dfGrade = pd.read_excel('BASE_DADOS1.2.xlsx', sheet_name='Final_table', usecols='B:K', skiprows=1, nrows=1000) #grade
dfDisciplinas = pd.read_excel('BASE_DADOS1.2.xlsx', sheet_name='Mock_Tables', usecols='B:C', skiprows=2, nrows=100) #disciplinas
dfProfessores = pd.read_excel('BASE_DADOS1.2.xlsx', sheet_name='Mock_Tables', usecols='E:H', skiprows=2, nrows=100) #Professores
dfLaboratorio = pd.read_excel('BASE_DADOS1.2.xlsx', sheet_name='Mock_Tables', usecols='J:M', skiprows=2, nrows=100) #Laboratorio
dfSemestres = pd.read_excel('BASE_DADOS1.2.xlsx', sheet_name='Mock_Tables', usecols='O:P', skiprows=2, nrows=20) #semestres
dfDiasSemana = pd.read_excel('BASE_DADOS1.2.xlsx', sheet_name='Mock_Tables', usecols='R:S', skiprows=2, nrows=6) #dias da semana
